<%@ Page Title="" Language="C#" MasterPageFile="~/Patient.Master" AutoEventWireup="true" CodeBehind="profilePatient.aspx.cs" Inherits="FrontEnd_NayaPakistan.profilePatient" %>
            ...
            <table>
                <tr>
                    ...
                    <td><div class="sideMenu">
                        <ul >
                            <li><a class="btn-light" href="profilePatient.aspx">Profile</a></li>
                    ...
                    <td><div>
                        <asp:DetailsView ID="PatientBasicDesc" runat="server" Height="350px" Width="700px" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Horizontal" CssClass="Table1">
