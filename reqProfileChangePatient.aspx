<%@ Page Title="" Language="C#" MasterPageFile="~/Patient.Master" AutoEventWireup="true" CodeBehind="reqProfileChangePatient.aspx.cs" Inherits="FrontEnd_NayaPakistan.reqProfileChangePatient" %>
                ...
                <tr>
                    ...
                    <td><div class="sideMenu">
                        <ul >
                            ...
                            <li><a class="btn-light" href="reqProfileChangePatient.aspx">Request Change</a></li>
                    ...
                    <td><div>
                        <table style="border-spacing:10px; border-collapse:separate">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:Button ID="patientSubButton" runat="server" Text="SUBMIT" CssClass="subBtn" OnClick="addEditRequestPatient"> </asp:Button>
                                </td>
                            </tr>
