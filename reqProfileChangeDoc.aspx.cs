...
{
    public partial class reqProfileChangeDoc : System.Web.UI.Page
    {
        ...
        {
            string toChange = toChangeAtt.Text;
            ...
            if (toChangeSQL == "salary")
            {
                ...
                dal.requestDataChange("doctor", toChangeSQL, id, changeValInt, string.Empty);
            }
            else
            {
                dal.requestDataChange("doctor", toChangeSQL, id, 0 , changeVal);
            }
            Response.Redirect("profileDoc.aspx");
        }

        protected void docSubButton_Click(object sender, EventArgs e)
        {
