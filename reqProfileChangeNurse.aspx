<%@ Page Title="" Language="C#" MasterPageFile="~/Nurse.master" AutoEventWireup="true" CodeBehind="reqProfileChangeNurse.aspx.cs" Inherits="FrontEnd_NayaPakistan.reqProfileChangeNurse" %>
                    ...
                    <td><div>
                        <table style="border-spacing:10px; border-collapse:separate">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:Button ID="nurseSubButton" runat="server" Text="SUBMIT" CssClass="subBtn" OnClick="addEditRequestNurse"> </asp:Button>
                                </td>
                            </tr>
