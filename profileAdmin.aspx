<%@ Page Title="" Language="C#" MasterPageFile="~/Doctor.Master" AutoEventWireup="true" CodeBehind="profileAdmin.aspx.cs" Inherits="FrontEnd_NayaPakistan.profileAdmin" %>
            ...
            <table>
                <tr>
                    ...
                    <td><div class="sideMenu">
                        <ul >
                            <li><a class="btn-light" href="profileAdmin.aspx">Profile</a></li>
                    ...
                    <td><div>
                        <asp:DetailsView ID="AdminBasicDesc" runat="server" Height="350px" Width="700px" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Horizontal" CssClass="Table1">
