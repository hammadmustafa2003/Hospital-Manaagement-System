...
{
    public partial class reqProfileChangePatient : System.Web.UI.Page
    {
        ...
        protected void addEditRequestPatient(object sender, EventArgs e)
        {
            ...
            if (toChangeSQL == "salary")
            {
                ...
                dal.requestDataChange("patient", toChangeSQL, id, changeValInt, string.Empty);
            }
            else
            {
                dal.requestDataChange("patient", toChangeSQL, id, 0, changeVal);
            }
