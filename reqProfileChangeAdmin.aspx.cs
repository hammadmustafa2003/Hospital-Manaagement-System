...
{
    public partial class reqProfileChangeAdmin : System.Web.UI.Page
    {
        ...
        protected void addEditRequestAdm(object sender, EventArgs e)
        {
            ...
            if (toChangeSQL == "salary")
            {
                ...
                dal.requestDataChange("admin", toChangeSQL, id, changeValInt, string.Empty);
            }
            else
            {
                dal.requestDataChange("admin", toChangeSQL, id, 0, changeVal);
            }
