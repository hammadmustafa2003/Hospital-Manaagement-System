<%@ Page Title="" Language="C#" MasterPageFile="~/Doctor.Master" AutoEventWireup="true" CodeBehind="profileDoc.aspx.cs" Inherits="FrontEnd_NayaPakistan.Profile" %>
    ...
    <html>
            ...
            <table>
                <tr>
                    ...
                    <td><div>
                        <asp:DetailsView ID="DocBasicDesc" runat="server" Height="350px" Width="700px" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Horizontal" CssClass="Table1">
