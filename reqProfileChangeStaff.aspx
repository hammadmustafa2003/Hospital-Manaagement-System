<%@ Page Title="" Language="C#" MasterPageFile="~/Doctor.Master" AutoEventWireup="true" CodeBehind="reqProfileChangeDoc.aspx.cs" Inherits="FrontEnd_NayaPakistan.reqProfileChangeDoc" %>
                    ...
                    <td><div>
                        <table style="border-spacing:10px; border-collapse:separate">
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="toChangeAttributeStaff" runat="server" CssClass="dropDownDoc">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:Button ID="docSubButton" runat="server" Text="SUBMIT" CssClass="subBtn" OnClick="addEditRequestDoc"> </asp:Button>
                                </td>
                            </tr>
